    ...
    return (
      ...
      >
        ...
        >
          ...
          <Animated.View style={[{ position: 'absolute', left: this.state.x, top: this.state.y, width: this.state.width, height: this.state.height, backgroundColor: 'transparent', opacity: 0 }, { transform: [{ scale: this.state.button_component_container_scale }] }]}>
            <TouchableOpacity
              onPress={this.toggle.bind(this)}
              activeOpacity={1.0}
              style={componentWrapperStyle}
...
PopoverTooltip.propTypes = {
  ...
  componentWrapperStyle: React.object,
  overlayStyle: React.object,
  tooltipContainerStyle: React.object,
  labelContainerStyle: React.object,
  labelSeparatorColor: React.string,
  labelStyle: React.object,
  setAbove: React.bool,
